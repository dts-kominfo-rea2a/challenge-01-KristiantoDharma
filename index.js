...
const arrRestaurantMonica = ["Bento", "Sushi", "Pancake", "Eggy", "Tempura", "Bento", "Eggy", "Padang", "Tteok", "Sushi", "Sushi"];

let setColorMonica = new Set(arrColorMonica);
let setRestaurantMonica = new Set(arrRestaurantMonica);
...
const arrRestaurantWendy = ["Tempura", "Bento", "Sushi", "Pancake", "Padang", "Katsu", "Geprek", "Pancake", "Eggy"];

let setColorWendy = new Set(arrColorWendy);
let setRestaurantWendy = new Set(arrRestaurantWendy);
